...
public class PieChart {
    ...
    public PieChart(Context context, PieChartView chart, int numValues, List<Container> values) {
    ...
    private void generateData() {
        ...
        if (hasCenterText1) {
            data.setCenterText1( this.values.get( 0 ).getDescription() );
    ...
    public void prepareDataAnimation() {
        ...
        for (SliceValue value : data.getValues()) {
            value.setTarget( values.get( i ).getPercent() );
            i++;
        }
